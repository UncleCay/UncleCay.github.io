...
const Header = () => {
  ...
  return (
    <header className="header__top footer">
      <h2 className="brand__name" title="Logo">OC</h2>
      <div className="header__links">
          <a className="header__sublink" href="http://BsGithub.com" target="_blank"><BsGithub /></a>
          <a className="header__sublink" href="http://linkedin.com" target="_blank"><BsLinkedin /></a>
          <a className="header__sublink" href={CV} target="_blank">CV</a>
